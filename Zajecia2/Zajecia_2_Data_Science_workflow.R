# 2.1. Import danych ----
# 
# Separatory oddzielaj¹ kolumny lub wartoœci dziesiêtne.
# Parametr	Wartoœæ	Opis
# header	TRUE / FALSE	Czy pierwszy wiersz to nag³ówki?
#   sep	";" "," "\t" " "	Separator kolumn (œrednik, przecinek, tab, spacja)
# dec	"." ","	Separator dziesiêtny (kropka lub przecinek)
# # Import pliku CSV
# Funkcja read.table() domyœlnie zak³ada:
#   •	header = FALSE
# •	sep = "" (spacje)
# •	dec = "."
